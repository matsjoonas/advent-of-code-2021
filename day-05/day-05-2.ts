...
const isAscending = function isAscending(segment: Segment): boolean {
  return segment[0][1] > segment[1][1];
}
...
const day052 = function day052(data: Buffer) {
